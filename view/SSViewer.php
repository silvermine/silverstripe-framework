	...
	public function process($item, $arguments = null, $inheritedScope = null) {
		...
		foreach(array('Content', 'Layout') as $subtemplate) {
			if(isset($this->chosenTemplates[$subtemplate])) {
				...
				$chosenTemplates = array( 'main' => $this->chosenTemplates[$subtemplate] );
				$self = $this;
				$underlay[$subtemplate] = function() use ($item, $arguments, $chosenTemplates, $self) {
					$subtemplateViewer = clone $self;
					// Disable requirements - this will be handled by the parent template
					$subtemplateViewer->includeRequirements(false);
					$subtemplateViewer->chosenTemplates = $chosenTemplates;
